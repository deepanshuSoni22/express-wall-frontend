...
import type { RebuildChoice, RebuildOption } from '@/types';
import rebuildBgVideo from '@/assets/white-curtain.mp4';

const rebuildOptions: RebuildOption[] = [
  {
    id: 'quote',
...
const Rebuild = () => {
  ...
  const [selectedOption, setSelectedOption] = useState<RebuildChoice | null>(null);

  const handleOptionSelect = (option: RebuildChoice) => {
    setSelectedOption(option);
    updateSession({ rebuildChoice: option });
  };
  ...
  return (
    <div className="page-with-video">
      <video
        ...
        preload="auto"
      >
        <source src={rebuildBgVideo} type="video/mp4" />
