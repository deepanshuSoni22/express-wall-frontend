...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: { sans: ['Bebas Neue', 'ui-sans-serif', 'system-ui', 'sans-serif'] },
      colors: {
      ...
      backgroundImage: {
        ...
        'gradient-breathe-in': 'var(--gradient-breathe-in)',
        'gradient-breathe-out': 'var(--gradient-breathe-out)',
      },
      boxShadow: {
      ...
      transitionProperty: {
        ...
        'breathe': 'var(--transition-breathe)',
      },
      scale: {
        '98': '0.98',
        '102': '1.02',
